...
ROOT_URLCONF = 'sistema_autenticacion.urls'
...
WSGI_APPLICATION = 'sistema_autenticacion.wsgi.application'

# Base de datos
DATABASES = {
    'default': {
        'ENGINE': os.getenv('DB_ENGINE', 'django.db.backends.mysql'),
        'NAME': os.getenv('DB_NAME', 'sistema_autenticacion'),
...
AUTHENTICATION_BACKENDS = [
    ...
    # Autenticación específica de allauth
...
#ACCOUNT_ADAPTER = 'usuarios.adaptador.AdaptadorCuentasManual'
#SOCIALACCOUNT_ADAPTER = 'usuarios.adaptador.AdaptadorCuentasSociales'

# Configuración de AllAuth (formato nuevo)
...
# Configuración para proveedores de autenticación social
...
# En producción, habilitar las siguientes configuraciones
if not DEBUG:
